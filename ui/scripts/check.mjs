...
const assertions = [
  ...
  ["web search proxy is bounded", exaApi.includes("EXA_PROXY_TOKEN") && exaApi.includes("UPSTASH_REDIS_REST_URL") && exaApi.includes("pipeline") && exaApi.includes("NODE_ENV") && exaApi.includes("MAX_BODY_BYTES") && exaApi.includes("authorization") && exaApi.includes("rate_limited")],
  ...
  ["approval uses its reviewed connector", js.includes("connector: { url: harnessUrl, token: harnessToken }") && js.includes("approval_connector_changed") && js.includes("mcpTool(connector.url, connector.token")],
