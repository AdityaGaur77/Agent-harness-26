...
const assertions = [
  ...
  ["prompt-first home", html.indexOf('id="home-prompt"') < html.indexOf('id="recent-missions"') && (html.includes("Tell me what to find") || html.includes("What would you like me to find"))],
  ...
  ["readable neutral token system", ["--canvas", "--line", "--ink", "--muted"].every((token) => css.includes(token)) && (css.includes("oklch") || css.includes("#FFFFFF")) && css.includes("#EAEAEA")],
